...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.logger.info(f"Aplicación iniciada - Versión {__version__}", modulo="MainWindow")
    ...
    def _crear_interfaz(self):
        ...
        # Conectar señales
        self.tab_configuracion.configuracion_actualizada.connect(self._on_configuracion_actualizada)
    ...
    def _limpiar_logs(self):
        ...
        if respuesta == QMessageBox.StandardButton.Yes:
            try:
                ...
                QMessageBox.information(self, "Logs limpiados",
    ...
    def _probar_conexion_smtp(self):
        ...
        if not self.config.is_smtp_configured():
            QMessageBox.warning(self, "SMTP no configurado",
                "Primero debe configurar el servidor SMTP.")
            return
...
<p><b>Soporte:</b> soporte@tuempresa.com</p>
"""
...
"""
    ...
    def closeEvent(self, event):
        ...
        respuesta = QMessageBox.question(
            self, "Salir", "¿Está seguro que desea salir?",
            QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No
        )
